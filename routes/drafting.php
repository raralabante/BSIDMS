...
Route::get('/draftingmaster/mydrafts/completed', [App\Http\Controllers\MyDraftsController::class, 'index_completed'])->name('my_drafts_completed');
Route::get('/draftingmaster/mydrafts/list/completed', [App\Http\Controllers\MyDraftsController::class, 'myDraftsCompletedList'])->name('my_drafts_completed.list');
