...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
                    ...
                    <div class="input-group p-2" style="width: 80%">
                        ...
                        <select class="form-select form-select-sm " id="customer">
                            ...
                            @foreach ($customers as $customer)
                                <option value="{{ $customer->name }}" data-team="{{ $customer->team }}">
                    ...
                    <div class=" p-2 toggle-column">
                        <div class="form-check form-check-inline p-0">
                            <div class="form-check form-switch">
                                <input class="form-check-input toggle-vis" type="checkbox" role="switch" data-column="0"
                                    id="column0" checked>
                        ...
                        <div class="form-check form-check-inline p-0">
                            <div class="form-check form-switch">
                                <input class="form-check-input toggle-vis" type="checkbox" role="switch" data-column="1"
                                    id="column1" checked>
            ...
            <div class="">
                <table id="multifilters_tbl" class="table table-bordered row-border order-column stripe hover"
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.popover__title_drafting', function() {
            ...
            $(".popover__content_drafting").css("transition",
