        ...
        $(document).ready(function() {
            ...
            var mydraftscheck_tbl = $('#mydraftscheck_tbl').DataTable({
                initComplete: function(settings, json) {
                    ...
                    var state = mydraftscheck_tbl.state.loaded();
                    if (state) {
                        $.each(mydraftscheck_tbl.columns().visible(), function(colIdx, value) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response == 0) {
                            ...
                            $("#warningToast .toast-body").html(
                                "<i class='fa-solid fa-ban'></i> You have an active job on drafting."
                            );
                            toastWarning.show();
                        }
                    ...
                    buttons: {
                        ...
                        confirm: function() {
                            $.ajax({
                                ...
                                url: "{{ route('my_drafts_check.setJobStatus', '') }}" +
                                    "/" + draft_id,
                                type: "GET",
                                success: function(response) {
                                    mydraftscheck_tbl.ajax.reload();
                    ...
                    buttons: {
                        ...
                        confirm: function() {
                            $.ajax({
                                ...
                                url: "{{ route('my_drafts_check.rejectCheck', '') }}" +
                                    "/" + draft_id,
                                type: "GET",
                                success: function(response) {
                                    mydraftscheck_tbl.ajax.reload();
