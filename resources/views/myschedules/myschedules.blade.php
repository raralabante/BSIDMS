  ...
  .ui-widget, #drafters{
    z-index: 10000;
      ...
      <body class="">
        ...
        @endif
          <table id="myschedules_tbl" class="table table-bordered row-border order-column stripe hover" width="100%">
          </table>
        </div>
      </body>
...
<script>
    $(document).ready( function () {
      ...
      var myschedules_tbl = $('#myschedules_tbl').DataTable({
          ajax: "{{ route('my_schedules.list') }}",
          dom: 'Bfrtip',
        //   processing: true,
        // serverSide: true,
        buttons: [
          ...
          columns: [
              ...
              {data: 'scheduling_hours', title: 'Scheduling Hours',
      ...
      $('#myschedules_tbl').on('click', '.active', function (){
        ...
        var job_number = $(this).data("job_number");
          ...
          $.ajax({
            ...
            url:  "{{route('my_schedules.setStatusOnOff','')}}"+"/"+draft_id,
                type:"GET",
                success:function(response){
                  ...
                  myschedules_tbl.ajax.reload();
                }
            });
      });

      $('#myschedules_tbl').on('click', '.for_checking', function (){
        var draft_id = $(this).data("id");
        var job_number = $(this).data("job_number");
          ...
          buttons: {
              ...
              confirm: function(){
                $.ajax({
                  ...
                  url:  "{{route('my_schedules.setJobStatus','')}}"+"/"+draft_id,
                type:"GET",
                success:function(response){
