            ...
            <div class="container-fluid p-5 " style="overflow: scroll">
                <div class="row">
                    <div class="">
                        ...
                        <br>
                        <table id="drafting_master_submitted_tbl"
        ...
        $(document).ready(function() {
            ...
            var drafting_master_submitted_tbl = $('#drafting_master_submitted_tbl').DataTable({
                initComplete: function(settings, json) {
                    ...
                    var state = drafting_master_submitted_tbl.state.loaded();
                    if (state) {
                        $.each(drafting_master_submitted_tbl.columns().visible(), function(colIdx,
                            value) {
            ...
            $(".clear_filters").click(function() {
                ...
                // $(".search_filter").val("");
                drafting_master_submitted_tbl.state.clear();
            ...
            channel.bind('my-event', function(data) {
                drafting_master_submitted_tbl.ajax.reload();
